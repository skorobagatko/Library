...
<div id="header" class="shell">
    <div id="logo"><h1><a href="#">Java Library</a></h1><span><a href="#">Java</a></span></div>
    <!-- Navigation -->
    <div id="navigation">
        <ul>
            ...
            <ul>
                <li>
                    <div class="product">
                        ...
                        <a href="#" class="buy-btn">BUY NOW <span class="price"><span class="low">$</span>22<span
...
<div id="footer" class="shell">
    <div class="top">
        <div class="cnt">
            ...
            <div class="cl">&nbsp;</div>
            <div class="copy">
                <p>&copy; <a href="#">BestSeller.com</a>. Design by <a href="http://css-free-templates.com/">CSS-FREE-TEMPLATES.COM</a>
                </p>
            </div>
        </div>
    </div>
